  ...
  return (
    <div>
      <h1 className="page-quote">
        “She was sitting in a garden more beautiful than even her rampaging
        imagination could ever have conjured up, and she was being serenaded by
        nature.” ― Lynn Kurland, Spellweaver{" "}
      </h1>
      ...
      <div className="right-container">
        <h1>
          From quiet business lunches, "Ladies night out," to Fairy Princess
          parties - We are committed to make your experience sophisticated and
          memorable for adult reservations and wonderfully magical when your
